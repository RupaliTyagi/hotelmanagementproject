...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        rbmale.setFont(new Font("serif",Font.TRUETYPE_FONT,14));
        rbmale.setBackground(Color.WHITE);
        add(rbmale);

        rbfemale= new JRadioButton("Female");
        rbfemale.setBackground(Color.WHITE);
        rbfemale.setBounds(280,200,70,25);
        rbfemale.setFont(new Font("serif",Font.TRUETYPE_FONT,14));
        rbfemale.setBackground(Color.WHITE);
        add(rbfemale);
